...
b = -0.1538520
cutoff = 0.5007
tb_gapdh = 12.8338795317303
tb_mical2 = 9.22653972254304
tb_ptpn1 = 6.60334035224599
sd_mical2 = 0.728255005650431
...
def show():
    ...
    # st.markdown('<p style="font-size:20px;">Nhập giá trị CT để dự đoán nguy cơ di căn xương ở bệnh nhân ung thư vú</p>', unsafe_allow_html=True)
    # st.markdown('<p style="font-size:20px;">---</p>', unsafe_allow_html=True)
    st.markdown("---")
    
    ###
    st.markdown("## Công cụ dự đoán nguy cơ di căn xương")
    st.write('<p style="font-size:20px;">Nhập giá trị CT để dự đoán nguy cơ di căn xương ở bệnh nhân ung thư vú</p>', unsafe_allow_html=True)
    ...
    prediction = None
    if submitted:
        risk_score, prediction = logistic_regression_predict(ptpn11_input, mical2_input, ref_input)
    ...
    **⚠️ Lưu ý quan trọng:** Đây là công cụ nghiên cứu và chỉ mang tính chất tham khảo. 
    ...
    st.markdown("---")
    st.markdown("### Tổng quan gene PTPN11 và MICAL2")
